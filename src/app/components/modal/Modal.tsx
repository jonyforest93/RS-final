...
export const Modal: React.FC<IModalProps> = ({ children, isDisplay, bg }) => {
  return (
    <div
    ...
    >
      <div
        className={`flex min-h-[200px] flex-col items-center justify-center gap-10 bg-${bg || '[#2a8e77]'} p-10 font-osvald text-xl text-white`}
      >
